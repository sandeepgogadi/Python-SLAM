...
from robot_06_d_histogram_filter import move, convolve, multiply
...
def kalman_filter_step(belief, control, measurement):
    ...
    mu_ = prediction.mu + kalman_gain*(measurement.mu - prediction.mu)
    sigma2_ = (1 - kalman_gain)*prediction.sigma2
    correction = Density(mu_, sigma2_)
