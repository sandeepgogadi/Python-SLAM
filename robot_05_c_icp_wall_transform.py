...
from robot import *
from robot_library import filter_step, concatenate_transform
from robot_04_a_project_landmarks import write_cylinders
from robot_04_d_apply_transform import estimate_transform, apply_transform, correct_pose
from robot_05_a_find_wall_pairs import get_subsampled_points, get_corresponding_points_on_wall
...
def get_icp_transform(world_points, iterations):
    ...
    for j in range(iterations):
        trans_points = [apply_transform(overall_trafo, p) for p in world_points]
        left, right = get_corresponding_points_on_wall(trans_points)
